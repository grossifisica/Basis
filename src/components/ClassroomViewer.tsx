                ...
                <div className="flex items-center gap-1.5">
                  {activePdfUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-1 px-2 py-1 rounded-md text-[11px] font-semibold text-stone-300 hover:text-white bg-stone-800 hover:bg-stone-700 transition-colors"
                      title="Abrir apresentação/documento original em nova guia"
                    >
